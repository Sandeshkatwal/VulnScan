...
Version 22.2.0-beta adds Dashboard Rendering Optimisation for Performance Review and Large Dataset Handling: reusable paginated tables, Lazy Loading sections, API page size controls, Large Dataset summaries, and Performance Diagnostics panels.
...
Version 20.9 adds an OWASP Report experience with executive summary, assessment quality score, A01-A10 coverage matrix, evidence filters, manual validation checklist, developer guidance, coverage gaps, and Markdown export through `/owasp/report/build`. Demo mode includes A01, A02, A03, A04, A05, A07, A08, and A10 indicators, with A06 and A09 shown as manual coverage gaps.
