...
const demoScopes: BugBountyScopeSummary[] = [{ program_id: 'demo-bug-bounty-program', program_name: 'Demo Bug Bounty Program', scope_file: 'data/bug_bounty/sample_program_scope.json' }]
