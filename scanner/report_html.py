...
def save_html_report(
    ...
    report = {
        ...
        "authenticated_crawl_summary": scan_result.get("authenticated_crawl_summary", {"enabled": False, "limitations": ["Authenticated Crawl was not enabled."]}),
        "authenticated_crawl_results": scan_result.get("authenticated_crawl_results", []),
        "authenticated_crawl_skipped": scan_result.get("authenticated_crawl_skipped", []),
        "authenticated_boundary_events": scan_result.get("authenticated_boundary_events", []),
        "auth_required_endpoint_classification": scan_result.get("auth_required_endpoint_classification", {"enabled": False}),
        "role_mapping_summary": scan_result.get("role_mapping_summary", {"enabled": False, "limitations": ["Role and Permission Mapping was not enabled."]}),
        "role_profiles": scan_result.get("role_profiles", []),
        "permission_matrix_summary": scan_result.get("permission_matrix_summary", {"enabled": False}),
        "role_endpoint_matrix": scan_result.get("role_endpoint_matrix", []),
        "manual_validation_plans": scan_result.get("manual_validation_plans", []),
        "role_comparison_notes": scan_result.get("role_comparison_notes", []),
        "access_control_test_plans": scan_result.get("access_control_test_plans", []),
        "access_control_observations": scan_result.get("access_control_observations", []),
        "access_control_retests": scan_result.get("access_control_retests", []),
        "a01_manual_validation_summary": scan_result.get("a01_manual_validation_summary", {"enabled": False}),
        "parameter_replay_plans": scan_result.get("parameter_replay_plans", []),
        "redacted_request_templates": scan_result.get("redacted_request_templates", []),
        "parameter_replay_observations": scan_result.get("parameter_replay_observations", []),
        "parameter_replay_retests": scan_result.get("parameter_replay_retests", []),
        "parameter_replay_summary": scan_result.get("parameter_replay_summary", {"enabled": False}),
        "business_logic_workflow_candidates": scan_result.get("business_logic_workflow_candidates", []),
        "business_logic_review_plans": scan_result.get("business_logic_review_plans", []),
        "business_logic_state_transition_maps": scan_result.get("business_logic_state_transition_maps", []),
        "business_logic_abuse_case_checklists": scan_result.get("business_logic_abuse_case_checklists", []),
        "business_logic_observations": scan_result.get("business_logic_observations", []),
        "business_logic_retests": scan_result.get("business_logic_retests", []),
        "business_logic_summary": scan_result.get("business_logic_summary", {"enabled": False}),
        "evidence_vault_items": scan_result.get("evidence_vault_items", []),
        "evidence_vault_links": scan_result.get("evidence_vault_links", []),
        "evidence_quality_summary": scan_result.get("evidence_quality_summary", {"enabled": False}),
        "evidence_redaction_summary": scan_result.get("evidence_redaction_summary", {"enabled": False}),
        "blocked_evidence_export_count": scan_result.get("blocked_evidence_export_count", 0),
        ...
        "owasp_assessment_report": scan_result.get("owasp_assessment_report", {}),
        "owasp_category_results": scan_result.get("owasp_category_results", []),
        "owasp_evidence_items": scan_result.get("owasp_evidence_items", []),
        "owasp_coverage_matrix": scan_result.get("owasp_coverage_matrix", []),
        "owasp_manual_validation_checklist": scan_result.get("owasp_manual_validation_checklist", []),
        "owasp_developer_recommendations": scan_result.get("owasp_developer_recommendations", []),
        "owasp_coverage_gaps": scan_result.get("owasp_coverage_gaps", []),
        "owasp_markdown_report_path": scan_result.get("owasp_markdown_report_path"),
